...
=======
    \item What is the size of the largest antichain?
>>>>>>> a60065088238b6e6052e58212521786d1662876b
  \end{enumerate}
  \end{exercise}
...
\begin{exercise}
<<<<<<< HEAD
	Show that $R \cong R \times R$. \textbf{Hint:} Use the fact that $R \cong \{0,1\}^{\mathbb{N}}$ and thus show that $\{0,1\}^{\mathbb{N}} \cong \{0,1\}^{\mathbb{N}} \times \{0,1\}^{\mathbb{N}}$.
=======
